...
app = typer.Typer(name="style", help="Manage style primers", rich_markup_mode="rich")
...
@app.command()
def create(
    name: str = typer.Argument(..., help="Style primer name (without .yaml extension)"),
    ...
    interactive: bool = typer.Option(
        True, "--interactive/--non-interactive", help="Use interactive style creation"
    ),
):
    """
    ...
    try:
        ...
        if interactive:
            ...
            personality = typer.prompt(
                "Personality traits", default="Professional, clear, engaging"
            )
...
def list_styles(
    ...
    try:
        ...
        for style in styles:
            scope_label = (
                "Global"
                if style.scope == TemplateScope.GLOBAL
                else f"Workspace ({style.workspace_name})"
            )
...
def copy(
    source: str = typer.Argument(
        ..., autocompletion=complete_template_name, help="Source style primer name"
    ),
    destination: str = typer.Argument(..., help="Destination style primer name"),
