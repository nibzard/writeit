...
class TemplateExtractor:
    ...
    def _extract_pipeline_template(
        self, template_file: Path
    ) -> Optional[TemplateDocumentation]:
    ...
    def _extract_style_primer(
        self, style_file: Path
    ) -> Optional[TemplateDocumentation]:
    ...
    def _extract_step(
        self, key: str, step_data: Dict[str, Any]
    ) -> TemplateStepDocumentation:
    ...
    def _extract_template_examples(
    ...
    def _extract_style_examples(
        ...
        example_usage = {
            ...
            "voice_characteristics": style_data.get("voice", {}).get(
                "characteristics", []
            ),
            "language_preferences": style_data.get("language", {}).get(
                "preferences", []
            ),
        }
