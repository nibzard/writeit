...
class APIExtractor:
    ...
    def _extract_endpoint(
        self, path: str, method: str, endpoint_data: Dict[str, Any]
    ) -> APIEndpointDocumentation:
        ...
        for status_code, response_data in responses.items():
            try:
                ...
                endpoint_doc.status_codes[status_int] = response_data.get(
                    "description", ""
                )
            except ValueError:
                endpoint_doc.status_codes[status_code] = response_data.get(
                    "description", ""
                )
    ...
    ) -> Optional[ParameterDocumentation]:
    ...
    def _extract_model(
        self, name: str, schema_data: Dict[str, Any]
    ) -> APIModelDocumentation:
    ...
    def generate_examples(
        self, endpoint: APIEndpointDocumentation
    ) -> List[CodeExample]:
    ...
    def _generate_python_example(
        ...
        try:
            ...
            example_lines = ["import requests", "", f"url = '{url}'"]
