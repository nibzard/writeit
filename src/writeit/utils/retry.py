...
LLM_RETRY_CONFIG = RetryConfig(
    max_attempts=3, initial_delay=1.0, max_delay=30.0, backoff_factor=2.0, jitter=True
)

FILE_RETRY_CONFIG = RetryConfig(
    max_attempts=5, initial_delay=0.1, max_delay=2.0, backoff_factor=1.5, jitter=True
)

NETWORK_RETRY_CONFIG = RetryConfig(
    max_attempts=5, initial_delay=0.5, max_delay=10.0, backoff_factor=2.0, jitter=True
)
