...
from writeit.shared.validation import PipelineValidator
...
class TestPipelineValidator:
    ...
    def test_missing_required_keys_fails_validation(self):
        ...
        invalid_pipeline = {
            "metadata": {"name": "Test Pipeline", "description": "Missing other fields"}
    ...
    def test_defaults_variables_recognized(self):
        ...
        pipeline_with_defaults = {
            ...
            "defaults": {
                "models": {"primary": "gpt-4", "secondary": "claude-3"},
        ...
        if not result.is_valid:
            print(
                f"Validation errors: {[issue.message for issue in result.issues if issue.is_error]}"
            )
