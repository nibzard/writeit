...
class TestConfigLoader:
    ...
    def test_load_config_hierarchical_override(self, config_loader, workspace_manager, temp_local_dir):
        ...
        with patch.dict(os.environ, {'WRITEIT_HOME': 'env_home'}):
            ...
            assert config["active_workspace"] == "local"  # From local (overrides global)
    ...
    def test_get_setting_default_value(self, config_loader):
        ...
        value = config_loader.get_setting("nonexistent.setting", default="default_value")
    ...
    def test_load_env_config_simple(self, config_loader):
        ...
        with patch.dict(os.environ, {
            'WRITEIT_HOME': '/custom/home',
            'WRITEIT_WORKSPACE': 'custom_workspace'
        }):
    ...
    def test_load_env_config_nested(self, config_loader):
        ...
        with patch.dict(os.environ, {
            'WRITEIT_LLM_PROVIDER': 'openai',
            'WRITEIT_LLM_API_KEY': 'secret_key'
        }):
            env_config = config_loader._load_env_config()
    ...
    def test_get_nested_value(self, config_loader):
        ...
        assert config_loader._get_nested_value(data, "level1.level2.level3") == "deep_value"
        assert config_loader._get_nested_value(data, "level1.level2") == {"level3": "deep_value"}
        assert config_loader._get_nested_value(data, "nonexistent", "default") == "default"
