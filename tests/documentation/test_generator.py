...
from writeit.docs.models import DocumentationConfig
...
"""
    ...
    def test_generate_all_documentation(self):
        ...
        has_content = (
            docs.api_docs is not None or
            len(docs.module_docs) > 0 or
            docs.cli_docs is not None or
            docs.template_docs is not None or
            len(docs.user_guides) > 0
        )
