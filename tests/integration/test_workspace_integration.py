...
class TestWorkspaceIntegration:
    ...
    def test_workspace_migration_flow(self, workspace_manager, temp_home):
        ...
        success, message = migrator.migrate_local_workspace(local_workspace, "migrated_project")
    ...
    def test_hierarchical_config_loading(self, workspace_manager, temp_home):
        ...
        with os.environ.copy() as env:
            ...
            try:
                ...
                assert config["workspace_setting"] == "workspace_value"  # From workspace
                assert config["active_workspace"] == "default"  # From global (not overridden by local)
    ...
    def test_storage_across_workspaces(self, workspace_manager):
        ...
        storage1.store_json("article_1", {"title": "Article 1", "content": "Content 1"}, db_name="articles")
        
        storage2.store_json("workspace_info", test_data2, db_name="metadata")
        storage2.store_json("article_3", {"title": "Article 3", "content": "Content 3"}, db_name="articles")
        ...
        article3_from_ws1 = storage1.load_json("article_3", db_name="articles", default=None)
